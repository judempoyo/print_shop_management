...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <ul class="flex flex-wrap -mb-px">
            <li class="mr-2">
                <a href="<?= PUBLIC_URL ?>order/show/<?= $order->id ?>"
                   class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 <?= !strpos($_SERVER['REQUEST_URI'], 'production') ? 'text-teal-600 border-teal-600 dark:text-teal-500 dark:border-teal-500' : '' ?>">
                    Détails
                </a>
            </li>
            <li class="mr-2">
                <a href="<?= PUBLIC_URL ?>order/<?= $order->id ?>/production"
                   class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 <?= strpos($_SERVER['REQUEST_URI'], 'production') !== false ? 'text-teal-600 border-teal-600 dark:text-teal-500 dark:border-teal-500' : '' ?>">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                <a href="<?= PUBLIC_URL ?>file/delete/<?= $file->id ?>" class="text-red-500 hover:text-red-700">Supprimer</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="flex justify-between pt-4">
        ...
        <div class="space-x-2">
            <a href="<?= PUBLIC_URL ?>order/edit/<?= $order->id ?>"
