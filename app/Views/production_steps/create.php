<div class="max-w-2xl mx-auto mt-8">
    <div class="p-6 bg-white rounded-xl shadow-lg dark:bg-gray-800 transition-all duration-300 hover:shadow-xl">
        ...
        <form action="<?= PUBLIC_URL ?>production-step/store/<?= $order->id ?>" method="POST" class="space-y-6">
            <div class="space-y-2">
            ...
            <div class="space-y-2">
                ...
                <textarea name="comments" rows="3"
                          class="block w-full px-4 py-3 text-gray-900 bg-white border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white transition duration-300"></textarea>
            </div>
